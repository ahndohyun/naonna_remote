	...
	<div class="container-content">
		...
		<div class="side-profile col-sm-4">
			<div class="card">
				...
				<img id="profileImage" src="/naonnaTest/resources/a1.jpg" alt="John"
					style="width: 100%">
				<h1>User Name</h1>
				<br />
				...
				<a id="printMessage" href="messageHome.do">Message</a>
				...
				<div id="kakao-logout-group" onclick="createKakaotalkLogout()">로그아웃</div>
