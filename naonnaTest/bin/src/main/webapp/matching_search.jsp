...
=======
    height: 100%;
    background-color: rgba(67, 68, 64, 0.4);
    padding-top: 100px;  /*top으로 부터 얼마나 띄울지*/
}
...
=======
   ...
   <div class="container-content">
      ...
      <div class="main col-sm-8">
         ...
         <div class="container-board">
            <button id="matching_creat" type="button" data-toggle="modal" data-target="#MatchingModal">매칭생성</button>
               <div class="modal fade" id="MatchingModal" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <table>
                                 <tr>
                                    <td class="table_menu">경기지역</td>
                                    <td class="table_contents"><input type="text" class="form-control" placeholder="Enter Ground Name" name="grouond_name" required></td>
                                 </tr>
                                 <tr>
                                    <td class="table_menu">경기일정</td>
                                    <td class="table_contents"><input type="text" placeholder="Enter Ground Name" name="grouond_name" required></td>
                                 </tr>
                                 <tr>
                                    <td class="table_menu">팀&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</td>
                                    <td class="table_contents"><input type="text" placeholder="Enter Ground Name" name="grouond_name" required></td>
